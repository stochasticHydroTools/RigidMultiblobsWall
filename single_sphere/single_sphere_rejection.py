...
partitionZ = s.generate_partition_function(sample_state)
for i in range(n_steps):
	# get a position from rejection function
	sample_state = s.single_sphere_generate_equilibrium_sample_rejection(sample_state, partitionZ)
...
s.plot_distribution(outFile) # generate historgram
