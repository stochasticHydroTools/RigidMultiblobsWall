...
Lubrication::Lubrication(double d_cut)
{
  ...
  SetMemberDataWall(base_dir+"/Resistance_Coefs/nDP_case_mob_scalars_wall_MB_2562_eig_thresh_1xL.txt",mob_scalars_wall_2562,Wall_2562_x,true);
  ...
  SetMemberDataWall(base_dir+"/Resistance_Coefs/nDP_case_res_scalars_wall_MB_1xL.txt",mob_scalars_wall_MB,Wall_MB_x,true);
}
...
BOOST_PYTHON_MODULE(Lubrication_Class_Spectral)
{
