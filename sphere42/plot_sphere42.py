...
class vtkTimerCallback():
  ...
  def execute(self,obj,event):
    ...
    r_vectors = sph42.get_sphere_42_blobs_r_vectors(
      self.locations[0], 
      self.orientations[0])
...
if __name__ == '__main__':
  ...
  locations = [[0., 0., 0.]]
  initial_r_vectors = sph42.get_sphere_42_blobs_r_vectors(locations[0], 
                                                          orientations[0])
  ...
  for k in range(N_SPHERES):
    ...
    blob_sources[k].SetRadius(sph42.VERTEX_A)
