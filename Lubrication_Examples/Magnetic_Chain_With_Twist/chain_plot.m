...
A = dlmread('/fhd/bsprinkle/Twist_Chain/twist_helix.chain_60.config');
% A = dlmread('/fhd/bsprinkle/Twist_Chain/twist_braid.hairpin_60.config');
% A = dlmread('/fhd/bsprinkle/Twist_Chain/twist_S.S_curve_60.config');
% A = dlmread('/fhd/bsprinkle/Twist_Chain/twist_helix_58deg.chain_60.config');


%A = dlmread('/fhd/bsprinkle/Mag_Chain/helix_anis_strong.chain_long_eq.config');

% A = dlmread('/fhd/bsprinkle/Twist_Chain/twist_helix_bend_test.chain_40.config');
% A = dlmread('/fhd/bsprinkle/Twist_Chain/no_twist_helix_bend_test.chain_40.config');
% A = dlmread('/fhd/bsprinkle/Twist_Chain/slight_twist_helix_bend_test.chain_40.config');

A = dlmread('/fhd/bsprinkle/Twist_Chain/homog_twist_helix.chain_60.config');
