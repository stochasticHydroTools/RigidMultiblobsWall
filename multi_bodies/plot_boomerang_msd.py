...
if __name__ == '__main__':
  ...
  for name in data_files:
    ...
    plot_time_dependent_msd(msd_statistics, [2, 2], 1, num_err_bars=120,
                            label=labels[ctr + 3], symbol=symbols[ctr], color='g')  ##[2,2]

    #plot_time_dependent_msd(msd_statistics, [4, 4], 1, num_err_bars=120,
    #                        label=None, symbol=symbols[ctr], color='b')
    #plot_time_dependent_msd(msd_statistics, [3, 3], 1, num_err_bars=120,
    #                        label=None, symbol=symbols[ctr], color='g')
    #plot_time_dependent_msd(msd_statistics, [5, 5], 1, num_err_bars=120,
    #                        label=None, symbol=symbols[ctr], color='r')
